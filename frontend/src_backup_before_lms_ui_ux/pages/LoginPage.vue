<template>
  <div class="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-brown-50">
    <div class="w-full max-w-md space-y-8">
      ...
      <!-- Login Form -->
      <form @submit.prevent="handleLogin" class="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 space-y-6 shadow-sm">
        <!-- Error message -->
        ...
        <div class="flex items-center justify-between">
          <label class="flex items-center gap-2 cursor-pointer">
            <input v-model="form.remember" type="checkbox" class="w-4 h-4 rounded border-gray-300 text-brown-700 focus:ring-brown-200" />
            <span class="text-sm text-gray-600">Remember me</span>
          </label>
          <a href="#" class="text-sm font-medium text-brown-700 hover:text-brown-800 transition-colors">Forgot password?</a>
        </div>
        ...
        <!-- Social login -->
        <div>
          <button type="button" class="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-gray-200 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
      ...
      <p class="text-center text-sm text-gray-500">
        ...
        <a href="#" class="font-semibold text-brown-700 hover:text-brown-800 transition-colors">Create an account</a>
      </p>
    </div>
  </div>
</template>
