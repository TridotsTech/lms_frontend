    ...
    <div class="w-full max-w-md space-y-8">
      ...
      <form @submit.prevent="handleLogin" class="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 space-y-6 shadow-sm">
        ...
        <div class="flex items-center justify-between">
          ...
          <router-link to="/forgot-password" class="text-sm font-medium text-brown-700 hover:text-brown-800 transition-colors">Forgot password?</router-link>
        </div>
      ...
      <p class="text-center text-sm text-gray-500">
        ...
        <router-link to="/signup" class="font-semibold text-brown-700 hover:text-brown-800 transition-colors">Create an account</router-link>
      </p>
    </div>
  </div>
</template>
